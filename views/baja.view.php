...
<body>
	...
	<!--Inicia Formulario-->
	<div class="contenedor">
		<h1 class="titulo">Elimine un Producto</h1>
		<hr class="border">
		<form  action="<?php htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" class="formulario" name="baja">
			...
			<?php endif; ?>	
			<i class="submit-btn fa fa-arrow-right" onclick="baja.submit()"></i>
		</form>
	</div>
