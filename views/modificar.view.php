...
<body>
	...
	<!--Inicia Formulario-->
	<div class="contenedor">
		<h1 class="titulo">Modifique un Producto</h1>
		<hr class="border">
		<form  action="<?php htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" class="formulario" name="modificar">
			...
			<!--En esta parte se ejecuta el error que saldra en el modificar.php-->
			...
			<?php endif; ?>	
			<i class="submit-btn fa fa-arrow-right" onclick="modificar.submit()"></i>
		</form>
	</div>
